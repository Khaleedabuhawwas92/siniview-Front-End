...
export class CitiesAPIControllers {


    findAll() {
        const FETCH_URL = new UrlAPIControllers().getCitiesUrl();
    ...
    findById(id) {
        const FETCH_URL = new UrlAPIControllers().getCitiesUrl() + id;
        return new HttpServiceConfig().get(FETCH_URL);
    }
...
export default CitiesAPIControllers;
